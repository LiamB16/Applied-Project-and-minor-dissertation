...
c.execute('select Bank_ID, current_balance from Bank where ID = %s;',[id])
...
trv.heading("1",text="BankID")
trv.heading("2",text="current balance")
...
def del_data(): # delete record 
    ...
    try:
        ...
        if my_var:
            ...
            select_query = 'insert into daily_activity values ("%s", "Deleted Bank", curdate(), curtime());'
            val2 = (id2)
